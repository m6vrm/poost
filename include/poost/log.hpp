...
#define POOST_TRACE_EX(settings, ...)                                                              \
    poost::log_print(settings, poost::LogLevel::Trace, __FILE_NAME__, __LINE__, __VA_ARGS__)
#define POOST_DEBUG_EX(settings, ...)                                                              \
    poost::log_print(settings, poost::LogLevel::Debug, __FILE_NAME__, __LINE__, __VA_ARGS__)
#define POOST_INFO_EX(settings, ...)                                                               \
    poost::log_print(settings, poost::LogLevel::Info, __FILE_NAME__, __LINE__, __VA_ARGS__)
#define POOST_WARN_EX(settings, ...)                                                               \
    poost::log_print(settings, poost::LogLevel::Warn, __FILE_NAME__, __LINE__, __VA_ARGS__)
#define POOST_ERROR_EX(settings, ...)                                                              \
    poost::log_print(settings, poost::LogLevel::Error, __FILE_NAME__, __LINE__, __VA_ARGS__)
#define POOST_FATAL_EX(settings, ...)                                                              \
    (poost::log_print(settings, poost::LogLevel::Fatal, __FILE_NAME__, __LINE__, __VA_ARGS__),     \
     std::exit(EXIT_FAILURE)) // todo: shouldn't call std::exit to terminate, but whatever
...
void log_print(const LogSettings &settings, LogLevel level, const char *file, int line,
               const char *fmt, ...);
